...
class UpdateIngresoRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        $ingresoModel = $ingreso instanceof Ingreso ? $ingreso : Ingreso::find($ingreso);

        return $ingresoModel ? $this->user()->can('update', $ingresoModel) : false;
    }
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $v) {
            ...
            if ($cuentaId) {
                ...
                if ($cuenta && ! $cuenta->activo && $cuentaId != $ingresoModel?->cuenta_ingreso_id) {
