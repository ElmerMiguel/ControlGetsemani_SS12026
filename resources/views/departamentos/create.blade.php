<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900">Nuevo Departamento</h1>
                <p class="text-sm text-slate-500">Registra un nuevo departamento, consejo, comité o congregación.</p>
            </div>
        ...
        <x-ui.card>
            <form method="POST" action="{{ route('departamentos.store') }}" class="space-y-6">
                ...
                <x-form.input
                    ...
                    name="nombre"
                    placeholder="Ej. Consejo de Ancianos"
                    required
                />
                ...
                <div>
                    ...
                    <textarea
                        ...
                        id="descripcion"
                        rows="3"
                        placeholder="Propósito u observaciones del departamento..."
